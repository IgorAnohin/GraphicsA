// WindowsProjectLab.cpp : Defines the entry point for the application.
//

#include "framework.h"
#include "WindowsProjectLab.h"
#include <math.h>
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_WINDOWSPROJECTLAB, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_WINDOWSPROJECTLAB));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_WINDOWSPROJECTLAB));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_WINDOWSPROJECTLAB);
    ...
    case WM_PAINT:
        {
            ...
            Rectangle(hdc, 122, 336, 162, 488);
            Rectangle(hdc, 255, 336, 295, 488);
